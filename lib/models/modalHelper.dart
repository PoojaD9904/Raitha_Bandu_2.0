...
class DiseaseApp extends StatefulWidget {
  @override
  _DiseaseAppState createState() => new _DiseaseAppState();
}
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            ...
            title: Text("Make a choice! ",style: TextStyle(color: Colors.black)),
  ...
  Widget build(BuildContext context) {
    ...
    stackChildren.add(Positioned(
      ...
      child: _image == null
        ...
        child: Text(
            'No image selected,\nUpload by clicking on button at the bottom right corner!',style:TextStyle(fontSize: 25,color: Colors.black)),
      )
          : Padding(
        padding: const EdgeInsets.all(8.0),
        child: Image.file(
...
//       ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text ('Plant Disease Recognition',style: TextStyle(color: Colors.white)),
